...
Raise an error if the test code snippet does returns false. I<< Optional. Type hash of node.  >>

=head2 warn_unless

Warn user if the tes code snippet does returns false. I<< Optional. Type hash of node.  >>
...
Specifies that the keys of the hash or list are copied from another hash or list in the configuration tree only when the hash is created.I<< Optional. Type uniline.  >>
