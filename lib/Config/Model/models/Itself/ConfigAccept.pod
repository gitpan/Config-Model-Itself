...
Used to categorize configuration elements in several "required skills". Use this feature if you need to hide a parameter to novice users. B<Deprecated> I<< Optional. Type enum. choice: 'master', 'advanced', 'beginner'. upstream_default: 'beginner'.  >> 
